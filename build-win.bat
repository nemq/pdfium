...
echo msbuild build\all.sln /p:Configuration=Release /p:Platform=x64 /p:PreferredToolArchitecture=x64 /m >> build_x64.bat
cmd /c build_x64.bat
...
echo msbuild build\all.sln /p:Configuration=Release /p:Platform=Win32 /p:PreferredToolArchitecture=x86 /m >> build_x86.bat
cmd /c build_x86.bat
